...
class NewRoomReservationDownPayment extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line('Payment: ' . Helper::convertToVnd($this->payment->price))
    ...
    {
        return [
            'message' => 'Room ' . $this->transaction->room->number . ' reservated by ' . $this->transaction->customer->name . '. Payment: ' . Helper::convertToVnd($this->payment->price),
