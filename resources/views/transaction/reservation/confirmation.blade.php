                    ...
                    <div class="card-body p-4">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="row mb-3">
                                    <label for="room_capacity" class="col-sm-2 col-form-label">Độ lớn</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="room_price" name="room_price"
                                            ...
                                            value="{{ Helper::convertToVnd($room->price) }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <div class="col-sm-12 mt-2">
                                <form method="POST"
                                    ...
                                    @csrf
                                    <div class="row mb-3">
                                        <label for="check_in" class="col-sm-2 col-form-label">Đăng ký vào</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="row mb-3">
                                        <label for="check_out" class="col-sm-2 col-form-label">Thanh toán vào</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="row mb-3">
                                        <label for="total_price" class="col-sm-2 col-form-label">Tổng giá</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="total_price" name="total_price"
                                                placeholder="col-form-label"
                                                value="{{ Helper::convertToVnd(Helper::getTotalPayment($dayDifference, $room->price)) }} "
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="minimum_dp" class="col-sm-2 col-form-label">Cọc</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="minimum_dp" name="minimum_dp"
                                                placeholder="col-form-label"
                                                value="{{ Helper::convertToVnd($downPayment) }} " readonly>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="downPayment" class="col-sm-2 col-form-label">Trả</label>
                                        <div class="col-sm-10">
                                            <input type="text"
...
<script>
    $('#downPayment').keyup(function() {
        $('#showPaymentType').text('R. ' + parseFloat($(this).val(), 10).toFixed(2).replace(
                /(\d)(?=(\d{3})+\.)/g, "$1.")
            .toString());
    });
</script>
