<form id="form-save-room" class="row g-3" method="POST" action="{{ route('room.update', ['room' => $room->id]) }}">
    ...
    <div class="col-md-12">
        <label for="room_status_id" class="form-label">Phòng Status</label>
    ...
    <div class="col-md-12">
        <label for="capacity" class="form-label">Độ lớn</label>
    ...
    <div class="col-md-12">
        <label for="view" class="form-label">ghi chú</label>
